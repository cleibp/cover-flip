<h1 align="center"> 🚀 Cover Flip </h1>

## ✍️ Descrição
Exemplificação de Cover Flip
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/cover-flip.git
    ```
1. Download:
    ### Download Manual
...
## 👋🏽 DEMO
[Publicação em Codepen](https://codepen.io/cleibp/pen/LYJZWdV) 
